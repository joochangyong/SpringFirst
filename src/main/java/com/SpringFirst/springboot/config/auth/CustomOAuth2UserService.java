...
import com.SpringFirst.springboot.config.auth.dto.OAuthAttributes;
import com.SpringFirst.springboot.config.auth.dto.SessionUser;
import com.SpringFirst.springboot.domain.user.User;
import com.SpringFirst.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        //userNameAttributeName : OAuth2 로그인 진행 시 키가 되는 필드값을 이야기함. Priomary Key와 같은 의미.
